...
DAT.GUI = function (a) {
  ...
  if (a.domElement)a.domElement.appendChild(this.domElement); else if (DAT.GUI.autoPlace) {
    if (DAT.GUI.autoPlacewebglcontainer == null)DAT.GUI.autoPlacewebglcontainer = document.createElement("div"), DAT.GUI.autoPlacewebglcontainer.setAttribute("id", "guidat"), document.body.appendChild(DAT.GUI.autoPlacewebglcontainer);
    DAT.GUI.autoPlacewebglcontainer.appendChild(this.domElement)
  }
...
DAT.GUI.hidden = !1;
DAT.GUI.autoPlace = !0;
DAT.GUI.autoPlacewebglcontainer = null;
