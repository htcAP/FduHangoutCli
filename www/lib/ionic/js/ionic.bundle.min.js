        ...
        link: function (e, g, h, l) {
          ...
          function n(e, f, g) {
            ...
            function p() {
              ...
              u || (z || null === n ? a[""].unshift({id: "", label: "", selected: !J}) : J || a[""].unshift({
                id: "?",
                label: "",
                selected: !0
              }));
    ...
    X.decorator("$animate", ["$delegate", "$$q", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", "$templateRequest", "$$jqLite", function (O, N, M, Y, y, H, P, W, Z, Q) {
      ...
      function U(a, c, b, d) {
        function h(e, a) {
          ...
          if (b || c)return "leave" == a && (c = b, b = null), u.push({event: a, fn: b}), J.push({event: a, fn: c}),
            !0
        }
        ...
        if (l) {
          ...
          if (x(p)) {
            ...
            return {
              node: l, event: c, className: b, isClassBased: E, isSetClassOperation: w, applyStyles: function () {
...
!function () {
    ...
    return L.prototype.initialize = function (e) {
      ...
      register: function (e, t) {
        ...
        if (b !== u && (b = u, _++), k)z = k.viewId, M = k.action, H = k.direction, k = null; else if (L && L.stateId === u)z = L.viewId, O = L.historyId, M = B, L.historyId === $.historyId ? H = x : $ && (H = V, i = f(L.historyId), i && i.parentHistoryId === $.historyId ? H = E : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = P))); else if (N && N.stateId === u)z = N.viewId, O = N.historyId, M = I, N.historyId === $.historyId ? H = A : $ && (H = V, $.historyId === d.parentHistoryId ? H = E : (i = f($.historyId), i && i.parentHistoryId === d.parentHistoryId && (H = P))), i = p(e), N.historyId && i.scope && (i.scope.$historyId = N.historyId, O = N.historyId); else if ($ && $.historyId !== O && d.cursor > -1 && d.stack.length > 0 && d.cursor < d.stack.length && d.stack[d.cursor].stateId === u) {
          ...
          if (s = r.createViewEle(t), this.isAbstractEle(s, t))return {action: "abstractView", direction: D, ele: s};
  ...
  c.directive("ionDeleteButton", function () {
    ...
    return {
      restrict: "E", require: ["^^ionItem", "^?ionList"], priority: Number.MAX_VALUE, compile: function (t, n) {
